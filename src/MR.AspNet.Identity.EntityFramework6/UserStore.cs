...
namespace MR.AspNet.Identity.EntityFramework6
{
	...
	public class UserStore<TUser, TRole, TUserRole, TUserClaim, TUserLogin, TRoleClaim, TContext, TKey, TUserToken> :
		...
		where TKey : IEquatable<TKey>
	{
		...
		/// <returns></returns>
		protected Task AddUserTokenAsync(TUserToken token)
		{
