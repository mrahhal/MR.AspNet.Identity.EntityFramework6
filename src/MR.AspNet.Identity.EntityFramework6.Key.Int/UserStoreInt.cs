...
namespace MR.AspNet.Identity.EntityFramework6
{
	...
	public class UserStoreInt<TContext> : UserStoreInt<IdentityUser<int, IdentityUserLoginInt, IdentityUserRoleInt, IdentityUserClaimInt, IdentityUserTokenInt>, TContext>
